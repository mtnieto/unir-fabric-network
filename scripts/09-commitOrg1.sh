...
peer lifecycle chaincode commit -o orderer0.unir.com:7050 --channelID $CHANNEL_NAME --name cc2 --version 1.0 --sequence 1 --init-required --tls true --cafile $ORDERER_CA --peerAddresses peer0.org1.unir.com:7051 --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.unir.com/peers/peer0.org1.unir.com/tls/ca.crt   >&log.txt
